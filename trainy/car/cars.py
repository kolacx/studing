...
from trainy.car.transmission import Transmission, Manual, Automatic
...
class Car(ABC):
    ...
    def __init__(self, brand, engine: Engine, wheel: Wheel, transmission: Transmission, formula=None):
        self.brand = brand
        self.formula = formula

        self.engine = engine
        self.transmission = self.transmission_ctrl(transmission)
        self.wheel = wheel
    ...
    def current_speed(self, rpm):
        ...
        speed = rpm * (w_h / ((self.transmission.main_steam * self.transmission.ratio()) * 530.616))
